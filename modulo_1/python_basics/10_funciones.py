...
saludarConNombre("Jhon Cena")
saludarConNombre("cody")
...
def saludo_con_prmetros_por_defecto(nombre, saludo="Hola", puntuacion="!"):
    print(f"{saludo}, {nombre}, {puntuacion}")


saludo_con_prmetros_por_defecto("Pedro", "buenos dias", "...")
saludo_con_prmetros_por_defecto("juan", puntuacion= "...")
saludo_con_prmetros_por_defecto("Carlos", "buenas tardes")


print("funcion parametros posicionles")

def sumar_todos(*args):
    print(f"rgumentos recibidos {args}")
    return sum(args)
...
print("funciones pramentros combindos con posicional")
...
mostrar_info("Frutas", "Naraanja", "piña", "melon", "manzana")



print("Funcio prametros clve valor variables")
...
configurar("loclHost", 80,443,8080, debug=True, timeout=30, ssl=True)
